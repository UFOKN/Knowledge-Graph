...
if __name__ == '__main__':
    FLOOD_file = 'data_FLOOD_UA.ttl'
    if os.path.exists(FLOOD_file):
        os.remove(FLOOD_file)
    write_name_spaces(FLOOD_file)
    write_props(FLOOD_file)

    flood_csv = r"C:\Users\david\OneDrive - University of Maine System\Documents\UMaine\UFOKN-ontologies\parquet to triples\data (Hamilton County, OH)\GIS - Hamilton County, OH\data_floodzone_FEMA_buffer_4326_wkt_UA-Only.csv"
