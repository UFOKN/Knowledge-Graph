...
def flood_proc(temp_row) -> str:
    ...
    time_of_first_flood = calc_time_of_first_flood()
    time_of_max = calc_time_of_max(time_of_first_flood)
    min_non_zero = calc_min_non_zero()
...
if __name__ == '__main__':
    FLOOD_file = 'data_FLOOD-100.ttl'
    if os.path.exists(FLOOD_file):
        os.remove(FLOOD_file)
    write_name_spaces(FLOOD_file)
    write_props(FLOOD_file)

    flood_csv = r"C:\Users\david\OneDrive - University of Maine System\Documents\UMaine\UFOKN-ontologies\parquet to triples\data (Hamilton County, OH)\GIS - Hamilton County, OH\Hamilton_100_data.csv"
